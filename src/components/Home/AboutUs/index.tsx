    ...
    <section id='About' className='py-20 bg-transparent overflow-hidden'>
      <div className='container mx-auto max-w-[1700px] px-4 md:px-8 lg:px-12'>
        ...
        <motion.div 
          ...
          className="mb-12"
        >
          <h2 className='text-5xl md:text-[6rem] lg:text-[7rem] font-black uppercase text-[#1a1a1a] tracking-tighter leading-none'>
            MORE THAN A GYM
          </h2>
        </motion.div>
        ...
        <div className="max-w-3xl">
          <motion.p 
            ...
            className='text-xl md:text-2xl text-gray-800 mb-10 leading-relaxed font-light flex flex-wrap gap-x-2'
          >
            {words.map((word, idx) => (
