      ...
      <div className='container mx-auto max-w-[1700px] px-4 md:px-8 lg:px-12'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-16'>
          {profiles.map((profile, index) => (
            <div 
              key={index} 
              className='relative flex flex-col items-center text-center p-6 md:p-10 xl:p-12 rounded-3xl border border-[#D0CACA] shadow-[0_10px_30px_rgba(0,0,0,0.08)] bg-gradient-to-b from-gray-200/80 via-gray-100/90 to-gray-200/80 backdrop-blur-xl min-h-[auto] md:min-h-[600px] lg:min-h-[860px] justify-center hover:-translate-y-3 hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)] transition-all duration-500 group'
            >
