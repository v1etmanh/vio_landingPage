...
const aboutWords = paragraphText.split(" ")
  ...
  return (
    <ReactLenis root options={{ lerp: 0.08, duration: 1.4 }}>
      <section id='Services' className='relative'>
        ...
        {/* ── AboutUs Section ── */}
        <div id='About' className='py-24 bg-transparent overflow-hidden'>
          <div className='container mx-auto max-w-[1700px] px-4 md:px-8 lg:px-12'>
            ...
            <motion.div 
              ...
              className="mb-12"
            >
              <h2 className='text-4xl md:text-5xl lg:text-6xl font-black uppercase text-[var(--color-darkmode)] tracking-tighter leading-none'>
                MORE THAN A GYM
              </h2>
            </motion.div>
            ...
            <div className="max-w-3xl">
              <motion.p 
                ...
                className='text-lg text-[var(--color-darkmode)]/90 mb-10 leading-relaxed font-light flex flex-wrap gap-x-2'
              >
              ...
              >
                <Button variant="dark" className="px-8 py-4 shadow-md hover:shadow-lg hover:-translate-y-1 group">
                  ...
                  <Icon icon="tabler:chevron-right" className="ml-6 text-2xl text-gray-400 group-hover:translate-x-1 transition-transform duration-200" />
                </Button>
              </motion.div>
            </div>
          </div>
